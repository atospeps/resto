...
class Functions_jobs {
    ...
    public function add($userid, $data){
        ...
        try {
            ...
            // Save job.
            $query = 'INSERT INTO usermanagement.jobs (userid, identifier, querytime, status, statusmessage, statusLocation, percentCompleted, outputs) '
                    . 'VALUES (' . join(',', $values) . ')';
