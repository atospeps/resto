    ...
    public function get($typeName, $params = array()) {
        switch ($typeName) {
            ...
            case parent::FILES:
                ...
                return $filesFunctions->getFiles(isset($params['userid']) ? $params['userid'] : null, isset($params['entryprocessing']) ? $params['entryprocessing'] : false, isset($params['fileid']) ? $params['fileid'] : null);
            ...
            case parent::FEATURES:
                $featuresFunctions = new Functions_features($this);
                return $featuresFunctions->getAllFeatures($params['number'], $params['offset']);
