...
class RestoDatabaseDriver_PostgreSQL extends RestoDatabaseDriver {
        ...
        switch ($typeName) {
            ...
            case parent::PROCESSING_JOBS_ITEMS:
                ...
                return $jobsFunctions->get($params['userid'], 
                    isset($params['jobid']) ? $params['jobid'] : null,
            ...
            case parent::FEATURES_DESCRIPTIONS:
                $featuresFunctions = new Functions_features($this);
                return $featuresFunctions->search($params['context'], $params['user'], $params['collection'], $params['filters'], $params['options'], $params['collections']);                
    ...
    public function remove($typeName, $params = array())
    {
        switch ($typeName) {
            ...
            case parent::CART_ITEM:
                $cartFunctions = new Functions_cart($this);
                return $cartFunctions->removeFromCart($params['email'], $params['items']);
