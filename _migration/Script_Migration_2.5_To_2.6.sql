...
--
-- ----------------------------------------------------------------------------------------
UPDATE _s2st.features SET s2takeid='G' || substr(title, 1, 4) || substr(title, 12, 16) || to_char(orbitnumber, 'FM000000') || '_N' || substr(title, 29, 2) || '.' || substr(title, 31, 2) where s2takeid like '% %' or s2takeid like '%#%';
